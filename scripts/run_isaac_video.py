#!/usr/bin/env python3
"""Render the complete solved trajectory as a multi-view Isaac Sim video."""
...
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "experiments/data_1/isaac_video_complete"
...
def main() -> None:
    ...
    try:
        ...
        print(f"Complete Isaac video: {report['output_video']}", flush=True)
        print(
